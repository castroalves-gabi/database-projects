...
CREATE VIEW NumEmpregadosPorDepartamento AS
...
CREATE VIEW NumEmpregadosPorLocalidade AS
...
CREATE VIEW ProjetosMaiorNumEmpregados AS
...
CASE WHEN e.Dependente = 1 THENdepartamentosgerentes 'Sim' ELSE 'Não' END AS PossuiDependentes
FROM Empregado e
